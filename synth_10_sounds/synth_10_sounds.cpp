...
struct mydspSIG0 {
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i1 = 0; i1 < count; i1 = i1 + 1) {
			iVec5[0] = 1;
			iRec12[0] = (iVec5[1] + iRec12[1]) % 65536;
...
struct mydsp : public dsp {
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "synth_10_sounds.dsp");
		...
		m->declare("name", "synth_10_sounds");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst2 = std::max<float>(1.0f, fConst1);
		fConst3 = 1.0f / fConst2;
		fConst4 = std::max<float>(1.0f, 0.02f * fConst0);
		fConst5 = 1.0f / fConst4;
		fConst6 = 0.3f / fConst2;
		fConst7 = std::tan(10995.574f / fConst0);
		fConst8 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst7));
		fConst9 = 1.0f / fConst7;
		fConst10 = (fConst9 + -1.4142135f) / fConst7 + 1.0f;
		fConst11 = (fConst9 + 1.4142135f) / fConst7 + 1.0f;
		fConst12 = 1.0f / fConst11;
		fConst13 = 1.0f / fConst0;
		fConst14 = 0.5f * fConst0;
		fConst15 = std::tan(376.99112f / fConst0);
		fConst16 = 1.0f / (fConst15 * fConst11);
		fConst17 = 1.0f / fConst15;
		fConst18 = 1.0f - fConst17;
		fConst19 = 1.0f / (fConst17 + 1.0f);
		fConst20 = std::max<float>(1.0f, 1.2f * fConst0);
		fConst21 = 1.0f / fConst20;
		fConst22 = std::max<float>(1.0f, 0.15f * fConst0);
		fConst23 = 1.0f / fConst22;
		fConst24 = 0.1f / std::max<float>(1.0f, 0.8f * fConst0);
		fConst25 = std::tan(7853.9814f / fConst0);
		fConst26 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst25));
		fConst27 = 1.0f / fConst25;
		fConst28 = (fConst27 + -1.4142135f) / fConst25 + 1.0f;
		fConst29 = (fConst27 + 1.4142135f) / fConst25 + 1.0f;
		fConst30 = 1.0f / fConst29;
		fConst31 = 0.8f / fConst0;
		fConst32 = 0.6f / fConst0;
		fConst33 = std::tan(251.32741f / fConst0);
		fConst34 = 1.0f / (fConst33 * fConst29);
		...
		fConst48 = 1.0f / std::max<float>(1.0f, 0.01f * fConst0);
		fConst49 = 4.0f / fConst0;
		fConst50 = 2.0f / fConst0;
		fConst51 = 1.0f / std::tan(18849.557f / fConst0);
		fConst52 = 1.0f - fConst51;
		fConst53 = 1.0f / (fConst51 + 1.0f);
		fConst54 = 1.0f / std::max<float>(1.0f, 0.4f * fConst0);
		fConst55 = std::max<float>(1.0f, 0.005f * fConst0);
		fConst56 = 1.0f / fConst55;
		fConst57 = 0.85f / std::max<float>(1.0f, 0.35f * fConst0);
		fConst58 = std::tan(13194.689f / fConst0);
		fConst59 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst58));
		fConst60 = 1.0f / fConst58;
		fConst61 = (fConst60 + -1.4142135f) / fConst58 + 1.0f;
		fConst62 = (fConst60 + 1.4142135f) / fConst58 + 1.0f;
		fConst63 = 1.0f / fConst62;
		fConst64 = 1.8f / fConst0;
		fConst65 = 1.0f / (fConst15 * fConst62);
		fConst66 = 1.0f / std::max<float>(1.0f, 1.8f * fConst0);
		fConst67 = std::max<float>(1.0f, 0.3f * fConst0);
		fConst68 = 1.0f / fConst67;
		fConst69 = 0.2f / fConst20;
		fConst70 = std::tan(6283.1855f / fConst0);
		fConst71 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst70));
		fConst72 = 1.0f / fConst70;
		fConst73 = (fConst72 + -1.4142135f) / fConst70 + 1.0f;
		fConst74 = 1.0f / ((fConst72 + 1.4142135f) / fConst70 + 1.0f);
		fConst75 = std::tan(14137.167f / fConst0);
		fConst76 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst75));
		fConst77 = 1.0f / fConst75;
		fConst78 = (fConst77 + -1.4142135f) / fConst75 + 1.0f;
		fConst79 = (fConst77 + 1.4142135f) / fConst75 + 1.0f;
		fConst80 = 1.0f / fConst79;
		fConst81 = 5.0f / fConst0;
		fConst82 = 0.05f * fConst0;
		fConst83 = 1.0f / (fConst15 * fConst79);
		fConst84 = std::tan(2513.2742f / fConst0);
		fConst85 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst84));
		fConst86 = 1.0f / fConst84;
		fConst87 = (fConst86 + -1.4142135f) / fConst84 + 1.0f;
		fConst88 = (fConst86 + 1.4142135f) / fConst84 + 1.0f;
		fConst89 = 1.0f / fConst88;
		fConst90 = 0.1f * fConst0;
		fConst91 = 0.5f / fConst0;
		fConst92 = std::tan(94.24778f / fConst0);
		fConst93 = 1.0f / (fConst92 * fConst88);
		fConst94 = 1.0f / fConst92;
		fConst95 = 1.0f - fConst94;
		fConst96 = 1.0f / (fConst94 + 1.0f);
		fConst97 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst44));
		fConst98 = (fConst45 + -1.4142135f) / fConst44 + 1.0f;
		fConst99 = (fConst45 + 1.4142135f) / fConst44 + 1.0f;
		fConst100 = 1.0f / fConst99;
		fConst101 = 1.0f / (fConst33 * fConst99);
		fConst102 = std::tan(15707.963f / fConst0);
		fConst103 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst102));
		fConst104 = 1.0f / fConst102;
		fConst105 = (fConst104 + -1.4142135f) / fConst102 + 1.0f;
		fConst106 = (fConst104 + 1.4142135f) / fConst102 + 1.0f;
		fConst107 = 1.0f / fConst106;
		fConst108 = 3.0f / fConst0;
		fConst109 = std::tan(157.07964f / fConst0);
		fConst110 = 1.0f / (fConst109 * fConst106);
		fConst111 = 1.0f / fConst109;
		fConst112 = 1.0f - fConst111;
		fConst113 = 1.0f / (fConst111 + 1.0f);
		fConst114 = 0.7f / std::max<float>(1.0f, 0.08f * fConst0);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("synth_10_sounds");
		ui_interface->addHorizontalSlider("freq", &fHslider0, FAUSTFLOAT(4.4e+02f), FAUSTFLOAT(27.5f), FAUSTFLOAT(4186.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("mode (0:Warm 1:Bright 2:Bass 3:EPiano 4:Organ 5:Pad 6:Lead 7:Bell 8:Strings 9:Brass)", &fHslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(9.0f), FAUSTFLOAT(1.0f));
		ui_interface->addButton("strike", &fButton0);
		ui_interface->addHorizontalSlider("volume", &fHslider2, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow3 = std::max<float>(fSlow2, 23.44895f);
		float fSlow4 = std::max<float>(2e+01f, std::fabs(fSlow3));
		float fSlow5 = fConst13 * fSlow4;
		float fSlow6 = fConst1 / fSlow4;
		float fSlow7 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst14 / fSlow3));
		int iSlow8 = static_cast<int>(fSlow7);
		int iSlow9 = iSlow8 + 1;
		float fSlow10 = std::floor(fSlow7);
		float fSlow11 = fSlow7 - fSlow10;
		float fSlow12 = fSlow10 + (1.0f - fSlow7);
		float fSlow13 = std::max<float>(1.1920929e-07f, std::fabs(fSlow2));
		float fSlow14 = fConst13 * fSlow13;
		float fSlow15 = 1.0f - fConst0 / fSlow13;
		float fSlow16 = static_cast<float>(fHslider1);
		float fSlow17 = static_cast<float>(fSlow16 == 9.0f);
		float fSlow18 = fConst31 * fSlow2;
		float fSlow19 = static_cast<float>(fSlow16 == 8.0f);
		float fSlow20 = fConst42 * fSlow2;
		float fSlow21 = fConst43 * fSlow2;
		float fSlow22 = fConst13 * fSlow2;
		float fSlow23 = static_cast<float>(fSlow16 == 7.0f);
		float fSlow24 = fConst49 * fSlow2;
		float fSlow25 = fConst50 * fSlow2;
		float fSlow26 = static_cast<float>(fSlow16 == 4.0f);
		float fSlow27 = std::max<float>(3.0f * fSlow2, 23.44895f);
		float fSlow28 = std::max<float>(2e+01f, std::fabs(fSlow27));
		float fSlow29 = fConst13 * fSlow28;
		float fSlow30 = fConst1 / fSlow28;
		float fSlow31 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst14 / fSlow27));
		int iSlow32 = static_cast<int>(fSlow31);
		int iSlow33 = iSlow32 + 1;
		float fSlow34 = std::floor(fSlow31);
		float fSlow35 = fSlow31 - fSlow34;
		float fSlow36 = fSlow34 + (1.0f - fSlow31);
		float fSlow37 = fConst64 * fSlow2;
		float fSlow38 = static_cast<float>(fSlow16 == 3.0f);
		float fSlow39 = std::max<float>(0.5f * fSlow2, 23.44895f);
		float fSlow40 = std::max<float>(2e+01f, std::fabs(fSlow39));
		float fSlow41 = fConst13 * fSlow40;
		float fSlow42 = fConst1 / fSlow40;
		float fSlow43 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst14 / fSlow39));
		...
		float fSlow49 = fConst74 * static_cast<float>(fSlow16 == 5.0f);
		float fSlow50 = 2.0f * fSlow2;
		float fSlow51 = static_cast<float>(fSlow16 == 6.0f);
		float fSlow52 = fConst91 * fSlow2;
		float fSlow53 = static_cast<float>(fSlow16 == 2.0f);
		float fSlow54 = static_cast<float>(fSlow16 == 1.0f);
		float fSlow55 = fConst108 * fSlow2;
		float fSlow56 = static_cast<float>(fSlow16 == 0.0f);
		float fSlow57 = static_cast<float>(fHslider2);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp2 = ((iTemp1) ? 0.0f : fSlow5 + fRec4[1]);
			fRec4[0] = fTemp2 - std::floor(fTemp2);
			float fTemp3 = mydsp_faustpower2_f(2.0f * fRec4[0] + -1.0f);
			fVec2[0] = fTemp3;
			float fTemp4 = static_cast<float>(iVec0[1]);
			float fTemp5 = fSlow6 * fTemp4 * (fTemp3 - fVec2[1]);
			fVec3[IOTA0 & 4095] = fTemp5;
			float fTemp6 = fSlow12 * fVec3[(IOTA0 - iSlow8) & 4095] + fSlow11 * fVec3[(IOTA0 - iSlow9) & 4095];
			float fTemp7 = fSlow14 + fRec5[1] + -1.0f;
			int iTemp8 = fTemp7 < 0.0f;
			float fTemp9 = fSlow14 + fRec5[1];
			fRec5[0] = ((iTemp8) ? fTemp9 : fTemp7);
			float fRec6 = ((iTemp8) ? fTemp9 : fSlow14 + fRec5[1] + fSlow15 * fTemp7);
			fRec3[0] = 0.75f * (2.0f * fRec6 + -1.0f) + 0.2f * (fTemp5 - fTemp6) - fConst12 * (fConst10 * fRec3[2] + fConst8 * fRec3[1]);
			float fTemp10 = fRec3[2] + fRec3[0] + 2.0f * fRec3[1];
			fVec4[0] = fTemp10;
			fRec2[0] = -(fConst19 * (fConst18 * fRec2[1] - fConst16 * (fTemp10 - fVec4[1])));
			fRec9[0] = 0.999f * fRec9[1] + fTemp5 - fTemp6;
			float fTemp11 = ((iTemp1) ? 0.0f : fConst32 + fRec13[1]);
			fRec13[0] = fTemp11 - std::floor(fTemp11);
			float fTemp12 = 0.002f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec13[0]), 65535))];
			float fTemp13 = std::max<float>(1.1920929e-07f, std::fabs(fSlow2 * (fTemp12 + 0.996f)));
			float fTemp14 = fRec10[1] + fConst13 * fTemp13;
			float fTemp15 = fTemp14 + -1.0f;
			int iTemp16 = fTemp15 < 0.0f;
			fRec10[0] = ((iTemp16) ? fTemp14 : fTemp15);
			float fRec11 = ((iTemp16) ? fTemp14 : fTemp14 + fTemp15 * (1.0f - fConst0 / fTemp13));
			float fTemp17 = std::max<float>(1.1920929e-07f, std::fabs(fSlow2 * (fTemp12 + 1.004f)));
			float fTemp18 = fRec14[1] + fConst13 * fTemp17;
			float fTemp19 = fTemp18 + -1.0f;
			int iTemp20 = fTemp19 < 0.0f;
			fRec14[0] = ((iTemp20) ? fTemp18 : fTemp19);
			float fRec15 = ((iTemp20) ? fTemp18 : fTemp18 + fTemp19 * (1.0f - fConst0 / fTemp17));
			fRec8[0] = 0.45f * (2.0f * fRec15 + -1.0f + 2.0f * fRec11 + -1.0f) + fSlow18 * fRec9[0] - fConst30 * (fConst28 * fRec8[2] + fConst26 * fRec8[1]);
			float fTemp21 = fRec8[2] + fRec8[0] + 2.0f * fRec8[1];
			fVec6[0] = fTemp21;
			fRec7[0] = -(fConst37 * (fConst36 * fRec7[1] - fConst34 * (fTemp21 - fVec6[1])));
			float fTemp22 = 1.0f - fConst41 * fTemp0;
			float fTemp23 = ((iTemp1) ? 0.0f : fSlow20 + fRec17[1]);
			fRec17[0] = fTemp23 - std::floor(fTemp23);
			float fTemp24 = ((iTemp1) ? 0.0f : fSlow21 + fRec18[1]);
			fRec18[0] = fTemp24 - std::floor(fTemp24);
			float fTemp25 = ((iTemp1) ? 0.0f : fSlow22 + fRec19[1]);
			fRec19[0] = fTemp25 - std::floor(fTemp25);
			float fTemp26 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec19[0]), 65535))];
			float fTemp27 = 0.8f * fTemp26 + 0.35f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec18[0]), 65535))] + 0.2f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec17[0]), 65535))];
			fVec7[0] = fTemp27;
			fRec16[0] = -(fConst47 * (fConst46 * fRec16[1] - (fTemp27 + fVec7[1])));
			float fTemp28 = ((iTemp1) ? 0.0f : fSlow24 + fRec21[1]);
			fRec21[0] = fTemp28 - std::floor(fTemp28);
			float fTemp29 = ((iTemp1) ? 0.0f : fSlow25 + fRec22[1]);
			fRec22[0] = fTemp29 - std::floor(fTemp29);
			float fTemp30 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec22[0]), 65535))];
			float fTemp31 = 0.6f * fTemp26;
			float fTemp32 = fTemp31 + 0.4f * fTemp30 + 0.2f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec21[0]), 65535))];
			fVec8[0] = fTemp32;
			fRec20[0] = -(fConst53 * (fConst52 * fRec20[1] - (fTemp32 + fVec8[1])));
			float fTemp33 = fConst56 * fRec1[0];
			float fTemp34 = fConst55 - fRec1[0];
			float fTemp35 = ((iTemp1) ? 0.0f : fSlow29 + fRec26[1]);
			fRec26[0] = fTemp35 - std::floor(fTemp35);
			float fTemp36 = mydsp_faustpower2_f(2.0f * fRec26[0] + -1.0f);
			fVec9[0] = fTemp36;
			float fTemp37 = fSlow30 * fTemp4 * (fTemp36 - fVec9[1]);
			fVec10[IOTA0 & 2047] = fTemp37;
			fRec25[0] = 0.999f * fRec25[1] + fTemp37 - (fSlow36 * fVec10[(IOTA0 - iSlow32) & 2047] + fSlow35 * fVec10[(IOTA0 - iSlow33) & 2047]);
			fRec24[0] = fTemp31 + 0.25f * fTemp30 + fSlow37 * fRec25[0] - fConst63 * (fConst61 * fRec24[2] + fConst59 * fRec24[1]);
			float fTemp38 = fRec24[2] + fRec24[0] + 2.0f * fRec24[1];
			fVec11[0] = fTemp38;
			fRec23[0] = -(fConst19 * (fConst18 * fRec23[1] - fConst65 * (fTemp38 - fVec11[1])));
			float fTemp39 = ((iTemp1) ? 0.0f : fSlow41 + fRec29[1]);
			fRec29[0] = fTemp39 - std::floor(fTemp39);
			float fTemp40 = mydsp_faustpower2_f(2.0f * fRec29[0] + -1.0f);
			fVec12[0] = fTemp40;
			float fTemp41 = fSlow42 * fTemp4 * (fTemp40 - fVec12[1]);
			fVec13[IOTA0 & 4095] = fTemp41;
			fRec28[0] = 0.999f * fRec28[1] + fTemp41 - (fSlow48 * fVec13[(IOTA0 - iSlow44) & 4095] + fSlow47 * fVec13[(IOTA0 - iSlow45) & 4095]);
			fRec27[0] = fSlow22 * (2.4f * fRec9[0] + 0.8f * fRec28[0]) - fConst74 * (fConst73 * fRec27[2] + fConst71 * fRec27[1]);
			float fTemp42 = ((iTemp1) ? 0.0f : fConst81 + fRec32[1]);
			fRec32[0] = fTemp42 - std::floor(fTemp42);
			float fTemp43 = 0.003f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec32[0]), 65535))] + 1.0f;
			float fTemp44 = fSlow50 * fTemp43;
			float fTemp45 = std::max<float>(fTemp44, 23.44895f);
			float fTemp46 = std::max<float>(2e+01f, std::fabs(fTemp45));
			float fTemp47 = ((iTemp1) ? 0.0f : fRec33[1] + fConst13 * fTemp46);
			fRec33[0] = fTemp47 - std::floor(fTemp47);
			float fTemp48 = mydsp_faustpower2_f(2.0f * fRec33[0] + -1.0f);
			fVec14[0] = fTemp48;
			float fTemp49 = fTemp4 * (fTemp48 - fVec14[1]) / fTemp46;
			fVec15[IOTA0 & 2047] = fTemp49;
			float fTemp50 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst14 / fTemp45));
			int iTemp51 = static_cast<int>(fTemp50);
			float fTemp52 = std::floor(fTemp50);
			float fTemp53 = fSlow2 * fTemp43;
			float fTemp54 = std::max<float>(1.1920929e-07f, std::fabs(fTemp53));
			float fTemp55 = fRec34[1] + fConst13 * fTemp54;
			float fTemp56 = fTemp55 + -1.0f;
			int iTemp57 = fTemp56 < 0.0f;
			fRec34[0] = ((iTemp57) ? fTemp55 : fTemp56);
			float fRec35 = ((iTemp57) ? fTemp55 : fTemp55 + fTemp56 * (1.0f - fConst0 / fTemp54));
			float fTemp58 = 2.0f * fRec35 + -1.0f;
			fRec31[0] = 0.8f * fTemp58 + fConst82 * (fTemp49 - fVec15[(IOTA0 - iTemp51) & 2047] * (fTemp52 + (1.0f - fTemp50)) - (fTemp50 - fTemp52) * fVec15[(IOTA0 - (iTemp51 + 1)) & 2047]) - fConst80 * (fConst78 * fRec31[2] + fConst76 * fRec31[1]);
			float fTemp59 = fRec31[2] + fRec31[0] + 2.0f * fRec31[1];
			fVec16[0] = fTemp59;
			fRec30[0] = -(fConst19 * (fConst18 * fRec30[1] - fConst83 * (fTemp59 - fVec16[1])));
			float fTemp60 = std::max<float>(fTemp53, 23.44895f);
			float fTemp61 = std::max<float>(2e+01f, std::fabs(fTemp60));
			float fTemp62 = ((iTemp1) ? 0.0f : fRec38[1] + fConst13 * fTemp61);
			fRec38[0] = fTemp62 - std::floor(fTemp62);
			float fTemp63 = mydsp_faustpower2_f(2.0f * fRec38[0] + -1.0f);
			fVec17[0] = fTemp63;
			float fTemp64 = fTemp4 * (fTemp63 - fVec17[1]) / fTemp61;
			fVec18[IOTA0 & 4095] = fTemp64;
			float fTemp65 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst14 / fTemp60));
			int iTemp66 = static_cast<int>(fTemp65);
			float fTemp67 = std::floor(fTemp65);
			float fTemp68 = ((iTemp1) ? 0.0f : fSlow52 + fRec39[1]);
			fRec39[0] = fTemp68 - std::floor(fTemp68);
			float fTemp69 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec39[0]), 65535))];
			fRec37[0] = 0.7f * fTemp69 + fConst90 * (fTemp64 - fVec18[(IOTA0 - iTemp66) & 4095] * (fTemp67 + (1.0f - fTemp65)) - (fTemp65 - fTemp67) * fVec18[(IOTA0 - (iTemp66 + 1)) & 4095]) - fConst89 * (fConst87 * fRec37[2] + fConst85 * fRec37[1]);
			float fTemp70 = fRec37[2] + fRec37[0] + 2.0f * fRec37[1];
			fVec19[0] = fTemp70;
			fRec36[0] = -(fConst96 * (fConst95 * fRec36[1] - fConst93 * (fTemp70 - fVec19[1])));
			float fTemp71 = std::max<float>(1.1920929e-07f, std::fabs(fTemp44));
			float fTemp72 = fRec42[1] + fConst13 * fTemp71;
			float fTemp73 = fTemp72 + -1.0f;
			int iTemp74 = fTemp73 < 0.0f;
			fRec42[0] = ((iTemp74) ? fTemp72 : fTemp73);
			float fRec43 = ((iTemp74) ? fTemp72 : fTemp72 + fTemp73 * (1.0f - fConst0 / fTemp71));
			fRec41[0] = 0.7f * fTemp58 + 0.3f * (2.0f * fRec43 + -1.0f) - fConst100 * (fConst98 * fRec41[2] + fConst97 * fRec41[1]);
			float fTemp75 = fRec41[2] + fRec41[0] + 2.0f * fRec41[1];
			fVec20[0] = fTemp75;
			fRec40[0] = -(fConst37 * (fConst36 * fRec40[1] - fConst101 * (fTemp75 - fVec20[1])));
			float fTemp76 = ((iTemp1) ? 0.0f : fRec46[1] + fSlow55 * fTemp43);
			fRec46[0] = fTemp76 - std::floor(fTemp76);
			float fTemp77 = ((iTemp1) ? 0.0f : fRec47[1] + fSlow25 * fTemp43);
			fRec47[0] = fTemp77 - std::floor(fTemp77);
			float fTemp78 = ((iTemp1) ? 0.0f : fRec48[1] + fSlow22 * fTemp43);
			fRec48[0] = fTemp78 - std::floor(fTemp78);
			fRec45[0] = 0.6f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec48[0]), 65535))] + 0.3f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec47[0]), 65535))] + 0.15f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec46[0]), 65535))] + 0.2f * fTemp69 - fConst107 * (fConst105 * fRec45[2] + fConst103 * fRec45[1]);
			float fTemp79 = fRec45[2] + fRec45[0] + 2.0f * fRec45[1];
			fVec21[0] = fTemp79;
			fRec44[0] = -(fConst113 * (fConst112 * fRec44[1] - fConst110 * (fTemp79 - fVec21[1])));
			float fTemp80 = fSlow57 * (std::max<float>(0.0f, std::min<float>(fTemp33, std::max<float>(fConst114 * fTemp34 + 1.0f, 0.3f)) * fTemp22) * (fSlow56 * fRec44[0] + fSlow54 * fRec40[0] + fSlow53 * fRec36[0] + fSlow51 * fRec30[0]) + fSlow49 * (fRec27[2] + fRec27[0] + 2.0f * fRec27[1]) * std::max<float>(0.0f, std::min<float>(fConst68 * fRec1[0], std::max<float>(fConst69 * (fConst67 - fRec1[0]) + 1.0f, 0.8f)) * (1.0f - fConst66 * fTemp0)) + fSlow38 * fRec23[0] * std::max<float>(0.0f, std::min<float>(fTemp33, std::max<float>(fConst57 * fTemp34 + 1.0f, 0.15f)) * (1.0f - fConst54 * fTemp0)) + fSlow26 * fRec20[0] * std::max<float>(0.0f, fTemp22 * std::min<float>(fConst48 * fRec1[0], 1.0f)) + fSlow23 * fRec16[0] * std::max<float>(0.0f, fTemp22 * std::min<float>(fConst39 * fRec1[0], std::max<float>(fConst40 * (fConst38 - fRec1[0]) + 1.0f, 0.0f))) + fSlow19 * fRec7[0] * std::max<float>(0.0f, std::min<float>(fConst23 * fRec1[0], std::max<float>(fConst24 * (fConst22 - fRec1[0]) + 1.0f, 0.9f)) * (1.0f - fConst21 * fTemp0)) + fSlow17 * fRec2[0] * std::max<float>(0.0f, std::min<float>(fConst5 * fRec1[0], std::max<float>(fConst6 * (fConst4 - fRec1[0]) + 1.0f, 0.7f)) * (1.0f - fConst3 * fTemp0)));
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp80);
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp80);
			iVec0[1] = iVec0[0];
			fVec1[1] = fVec1[0];
			iRec0[1] = iRec0[0];
			fRec1[1] = fRec1[0];
	...
	#define FAUST_FILE_NAME "synth_10_sounds.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("freq", fHslider0, 4.4e+02f, 27.5f, 4186.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("mode (0:Warm 1:Bright 2:Bass 3:EPiano 4:Organ 5:Pad 6:Lead 7:Bell 8:Strings 9:Brass)", fHslider1, 0.0f, 0.0f, 9.0f, 1.0f);
	FAUST_ADDBUTTON("strike", fButton0);
	FAUST_ADDHORIZONTALSLIDER("volume", fHslider2, 0.5f, 0.0f, 1.0f, 0.001f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, freq, "freq", fHslider0, 4.4e+02f, 27.5f, 4186.0f, 0.01f) \
		p(HORIZONTALSLIDER, mode_(0:Warm_1:Bright_2:Bass_3:EPiano_4:Organ_5:Pad_6:Lead_7:Bell_8:Strings_9:Brass), "mode (0:Warm 1:Bright 2:Bass 3:EPiano 4:Organ 5:Pad 6:Lead 7:Bell 8:Strings 9:Brass)", fHslider1, 0.0f, 0.0f, 9.0f, 1.0f) \
		p(BUTTON, strike, "strike", fButton0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, volume, "volume", fHslider2, 0.5f, 0.0f, 1.0f, 0.001f) \
...
synth_10_sounds::synth_10_sounds() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
synth_10_sounds::~synth_10_sounds()
{
    delete fDSP;
    delete fUI;
    for (int i = 0; i < fDSP->getNumInputs(); i++) {
...
void synth_10_sounds::updateImp(void)
{
#if MIDICTRL
...
void synth_10_sounds::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void synth_10_sounds::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float synth_10_sounds::getParamValue(const std::string& path)
{
