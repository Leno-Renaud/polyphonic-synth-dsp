...
struct mydspSIG0 {
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i1 = 0; i1 < count; i1 = i1 + 1) {
			iVec6[0] = 1;
			iRec17[0] = (iVec6[1] + iRec17[1]) % 65536;
...
struct mydsp : public dsp {
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "parameters_sounds.dsp");
		...
		m->declare("name", "parameters_sounds");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst3 = std::max<float>(1.0f, fConst2);
		fConst4 = 1.0f / fConst3;
		fConst5 = std::max<float>(1.0f, 0.02f * fConst0);
		fConst6 = 1.0f / fConst5;
		fConst7 = 0.3f / fConst3;
		fConst8 = std::tan(10995.574f / fConst0);
		fConst9 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst8));
		fConst10 = 1.0f / fConst8;
		fConst11 = (fConst10 + -1.4142135f) / fConst8 + 1.0f;
		fConst12 = (fConst10 + 1.4142135f) / fConst8 + 1.0f;
		fConst13 = 1.0f / fConst12;
		fConst14 = 1.0f / fConst0;
		fConst15 = 0.5f * fConst0;
		fConst16 = std::tan(376.99112f / fConst0);
		fConst17 = 1.0f / (fConst16 * fConst12);
		fConst18 = 1.0f / fConst16;
		fConst19 = 1.0f - fConst18;
		fConst20 = 1.0f / (fConst18 + 1.0f);
		fConst21 = std::max<float>(1.0f, 1.2f * fConst0);
		fConst22 = 1.0f / fConst21;
		fConst23 = std::max<float>(1.0f, 0.15f * fConst0);
		fConst24 = 1.0f / fConst23;
		fConst25 = 0.1f / std::max<float>(1.0f, 0.8f * fConst0);
		fConst26 = std::tan(7853.9814f / fConst0);
		fConst27 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst26));
		fConst28 = 1.0f / fConst26;
		fConst29 = (fConst28 + -1.4142135f) / fConst26 + 1.0f;
		fConst30 = (fConst28 + 1.4142135f) / fConst26 + 1.0f;
		fConst31 = 1.0f / fConst30;
		fConst32 = 0.8f / fConst0;
		fConst33 = std::tan(251.32741f / fConst0);
		fConst34 = 1.0f / (fConst33 * fConst30);
		fConst35 = 1.0f / fConst33;
		fConst36 = 1.0f - fConst35;
		fConst37 = 1.0f / (fConst35 + 1.0f);
		fConst38 = std::max<float>(1.0f, 0.001f * fConst0);
		fConst39 = 1.0f / fConst38;
		fConst40 = 1.0f / std::max<float>(1.0f, 1.5f * fConst0);
		fConst41 = 1.0f / std::max<float>(1.0f, 0.2f * fConst0);
		fConst42 = 5.1f / fConst0;
		fConst43 = 2.7f / fConst0;
		fConst44 = std::tan(28274.334f / fConst0);
		fConst45 = 1.0f / fConst44;
		fConst46 = 1.0f - fConst45;
		fConst47 = 1.0f / (fConst45 + 1.0f);
		fConst48 = 1.0f / std::max<float>(1.0f, 1.8f * fConst0);
		fConst49 = std::max<float>(1.0f, 0.3f * fConst0);
		fConst50 = 1.0f / fConst49;
		fConst51 = 0.2f / fConst21;
		fConst52 = std::tan(6283.1855f / fConst0);
		fConst53 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst52));
		fConst54 = 1.0f / fConst52;
		fConst55 = (fConst54 + -1.4142135f) / fConst52 + 1.0f;
		fConst56 = 1.0f / ((fConst54 + 1.4142135f) / fConst52 + 1.0f);
		fConst57 = 1.0f / std::max<float>(1.0f, 0.4f * fConst0);
		fConst58 = std::max<float>(1.0f, 0.005f * fConst0);
		fConst59 = 1.0f / fConst58;
		fConst60 = 0.85f / std::max<float>(1.0f, 0.35f * fConst0);
		fConst61 = std::tan(13194.689f / fConst0);
		fConst62 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst61));
		fConst63 = 1.0f / fConst61;
		fConst64 = (fConst63 + -1.4142135f) / fConst61 + 1.0f;
		fConst65 = (fConst63 + 1.4142135f) / fConst61 + 1.0f;
		fConst66 = 1.0f / fConst65;
		fConst67 = 1.8f / fConst0;
		fConst68 = 2.0f / fConst0;
		fConst69 = 1.0f / (fConst16 * fConst65);
		fConst70 = std::tan(14137.167f / fConst0);
		fConst71 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst70));
		fConst72 = 1.0f / fConst70;
		fConst73 = (fConst72 + -1.4142135f) / fConst70 + 1.0f;
		fConst74 = (fConst72 + 1.4142135f) / fConst70 + 1.0f;
		fConst75 = 1.0f / fConst74;
		fConst76 = 0.05f * fConst0;
		fConst77 = 1.0f / (fConst16 * fConst74);
		fConst78 = 4.0f / fConst0;
		fConst79 = 1.0f / std::tan(18849.557f / fConst0);
		fConst80 = 1.0f - fConst79;
		fConst81 = 1.0f / (fConst79 + 1.0f);
		fConst82 = std::tan(2513.2742f / fConst0);
		fConst83 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst82));
		fConst84 = 1.0f / fConst82;
		fConst85 = (fConst84 + -1.4142135f) / fConst82 + 1.0f;
		fConst86 = (fConst84 + 1.4142135f) / fConst82 + 1.0f;
		fConst87 = 1.0f / fConst86;
		fConst88 = 0.1f * fConst0;
		fConst89 = 0.5f / fConst0;
		fConst90 = std::tan(94.24778f / fConst0);
		fConst91 = 1.0f / (fConst90 * fConst86);
		fConst92 = 1.0f / fConst90;
		fConst93 = 1.0f - fConst92;
		fConst94 = 1.0f / (fConst92 + 1.0f);
		fConst95 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst44));
		fConst96 = (fConst45 + -1.4142135f) / fConst44 + 1.0f;
		fConst97 = (fConst45 + 1.4142135f) / fConst44 + 1.0f;
		fConst98 = 1.0f / fConst97;
		fConst99 = 1.0f / (fConst33 * fConst97);
		fConst100 = std::tan(15707.963f / fConst0);
		fConst101 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst100));
		fConst102 = 1.0f / fConst100;
		fConst103 = (fConst102 + -1.4142135f) / fConst100 + 1.0f;
		fConst104 = (fConst102 + 1.4142135f) / fConst100 + 1.0f;
		fConst105 = 1.0f / fConst104;
		fConst106 = 3.0f / fConst0;
		fConst107 = std::tan(157.07964f / fConst0);
		fConst108 = 1.0f / (fConst107 * fConst104);
		fConst109 = 1.0f / fConst107;
		fConst110 = 1.0f - fConst109;
		fConst111 = 1.0f / (fConst109 + 1.0f);
		fConst112 = 0.7f / std::max<float>(1.0f, 0.08f * fConst0);
	}
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider4 = static_cast<FAUSTFLOAT>(0.003f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("parameters_sounds");
		ui_interface->addHorizontalSlider("Filter/Highpass", &fHslider5, FAUSTFLOAT(2e+01f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(2e+03f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("Filter/Lowpass", &fHslider0, FAUSTFLOAT(2e+04f), FAUSTFLOAT(2e+02f), FAUSTFLOAT(2e+04f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("Modulation/VibratoDepth", &fHslider4, FAUSTFLOAT(0.003f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.02f), FAUSTFLOAT(0.0001f));
		...
		ui_interface->addHorizontalSlider("Spatial/Pan", &fHslider6, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		...
		ui_interface->addHorizontalSlider("volume", &fHslider7, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow7 = static_cast<float>(fHslider1);
		float fSlow8 = std::max<float>(fSlow7, 23.44895f);
		float fSlow9 = std::max<float>(2e+01f, std::fabs(fSlow8));
		float fSlow10 = fConst14 * fSlow9;
		float fSlow11 = fConst2 / fSlow9;
		float fSlow12 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst15 / fSlow8));
		int iSlow13 = static_cast<int>(fSlow12);
		int iSlow14 = iSlow13 + 1;
		float fSlow15 = std::floor(fSlow12);
		float fSlow16 = fSlow12 - fSlow15;
		float fSlow17 = fSlow15 + (1.0f - fSlow12);
		float fSlow18 = std::max<float>(1.1920929e-07f, std::fabs(fSlow7));
		float fSlow19 = fConst14 * fSlow18;
		float fSlow20 = 1.0f - fConst0 / fSlow18;
		float fSlow21 = static_cast<float>(fHslider2);
		float fSlow22 = static_cast<float>(fSlow21 == 9.0f);
		float fSlow23 = fConst32 * fSlow7;
		float fSlow24 = std::max<float>(1.1920929e-07f, std::fabs(0.99f * fSlow7));
		float fSlow25 = fConst14 * fSlow24;
		float fSlow26 = 1.0f - fConst0 / fSlow24;
		float fSlow27 = std::max<float>(1.1920929e-07f, std::fabs(1.01f * fSlow7));
		float fSlow28 = fConst14 * fSlow27;
		float fSlow29 = 1.0f - fConst0 / fSlow27;
		float fSlow30 = static_cast<float>(fSlow21 == 8.0f);
		float fSlow31 = fConst42 * fSlow7;
		float fSlow32 = fConst43 * fSlow7;
		float fSlow33 = fConst14 * fSlow7;
		float fSlow34 = static_cast<float>(fSlow21 == 7.0f);
		float fSlow35 = std::max<float>(0.5f * fSlow7, 23.44895f);
		float fSlow36 = std::max<float>(2e+01f, std::fabs(fSlow35));
		float fSlow37 = fConst14 * fSlow36;
		float fSlow38 = fConst2 / fSlow36;
		float fSlow39 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst15 / fSlow35));
		int iSlow40 = static_cast<int>(fSlow39);
		int iSlow41 = iSlow40 + 1;
		float fSlow42 = std::floor(fSlow39);
		float fSlow43 = fSlow39 - fSlow42;
		float fSlow44 = fSlow42 + (1.0f - fSlow39);
		float fSlow45 = fConst56 * static_cast<float>(fSlow21 == 5.0f);
		float fSlow46 = std::max<float>(3.0f * fSlow7, 23.44895f);
		float fSlow47 = std::max<float>(2e+01f, std::fabs(fSlow46));
		float fSlow48 = fConst14 * fSlow47;
		float fSlow49 = fConst2 / fSlow47;
		float fSlow50 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst15 / fSlow46));
		int iSlow51 = static_cast<int>(fSlow50);
		int iSlow52 = iSlow51 + 1;
		float fSlow53 = std::floor(fSlow50);
		float fSlow54 = fSlow50 - fSlow53;
		float fSlow55 = fSlow53 + (1.0f - fSlow50);
		float fSlow56 = fConst67 * fSlow7;
		float fSlow57 = fConst68 * fSlow7;
		float fSlow58 = static_cast<float>(fSlow21 == 3.0f);
		float fSlow59 = fConst14 * static_cast<float>(fHslider3);
		float fSlow60 = static_cast<float>(fHslider4);
		float fSlow61 = 2.0f * fSlow7;
		float fSlow62 = static_cast<float>(fSlow21 == 6.0f);
		float fSlow63 = fConst78 * fSlow7;
		float fSlow64 = static_cast<float>(fSlow21 == 4.0f);
		float fSlow65 = fConst89 * fSlow7;
		float fSlow66 = static_cast<float>(fSlow21 == 2.0f);
		float fSlow67 = static_cast<float>(fSlow21 == 1.0f);
		float fSlow68 = fConst106 * fSlow7;
		float fSlow69 = static_cast<float>(fSlow21 == 0.0f);
		float fSlow70 = 1.0f / std::tan(fConst1 * static_cast<float>(fHslider5));
		float fSlow71 = 1.0f - fSlow70;
		float fSlow72 = 1.0f / (fSlow70 + 1.0f);
		float fSlow73 = static_cast<float>(fHslider6);
		float fSlow74 = static_cast<float>(fHslider7);
		float fSlow75 = fSlow74 * (1.0f - fSlow73);
		float fSlow76 = fSlow73 * fSlow74;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec0[0] = 1;
			fVec1[0] = fSlow5;
			iRec2[0] = iSlow6 * (iRec2[1] + 1);
			float fTemp0 = static_cast<float>(iRec2[0]);
			fRec3[0] = fSlow5 + fRec3[1] * static_cast<float>(fVec1[1] >= fSlow5);
			int iTemp1 = 1 - iVec0[1];
			float fTemp2 = ((iTemp1) ? 0.0f : fSlow10 + fRec6[1]);
			fRec6[0] = fTemp2 - std::floor(fTemp2);
			float fTemp3 = mydsp_faustpower2_f(2.0f * fRec6[0] + -1.0f);
			fVec2[0] = fTemp3;
			float fTemp4 = static_cast<float>(iVec0[1]);
			float fTemp5 = fSlow11 * fTemp4 * (fTemp3 - fVec2[1]);
			fVec3[IOTA0 & 4095] = fTemp5;
			float fTemp6 = fSlow17 * fVec3[(IOTA0 - iSlow13) & 4095] + fSlow16 * fVec3[(IOTA0 - iSlow14) & 4095];
			float fTemp7 = fSlow19 + fRec7[1] + -1.0f;
			int iTemp8 = fTemp7 < 0.0f;
			float fTemp9 = fSlow19 + fRec7[1];
			fRec7[0] = ((iTemp8) ? fTemp9 : fTemp7);
			float fRec8 = ((iTemp8) ? fTemp9 : fSlow19 + fRec7[1] + fSlow20 * fTemp7);
			fRec5[0] = 0.75f * (2.0f * fRec8 + -1.0f) + 0.2f * (fTemp5 - fTemp6) - fConst13 * (fConst11 * fRec5[2] + fConst9 * fRec5[1]);
			float fTemp10 = fRec5[2] + fRec5[0] + 2.0f * fRec5[1];
			fVec4[0] = fTemp10;
			fRec4[0] = -(fConst20 * (fConst19 * fRec4[1] - fConst17 * (fTemp10 - fVec4[1])));
			fRec11[0] = 0.999f * fRec11[1] + fTemp5 - fTemp6;
			float fTemp11 = fSlow25 + fRec12[1] + -1.0f;
			int iTemp12 = fTemp11 < 0.0f;
			float fTemp13 = fSlow25 + fRec12[1];
			fRec12[0] = ((iTemp12) ? fTemp13 : fTemp11);
			float fRec13 = ((iTemp12) ? fTemp13 : fSlow25 + fRec12[1] + fSlow26 * fTemp11);
			float fTemp14 = fSlow28 + fRec14[1] + -1.0f;
			int iTemp15 = fTemp14 < 0.0f;
			float fTemp16 = fSlow28 + fRec14[1];
			fRec14[0] = ((iTemp15) ? fTemp16 : fTemp14);
			float fRec15 = ((iTemp15) ? fTemp16 : fSlow28 + fRec14[1] + fSlow29 * fTemp14);
			fRec10[0] = 0.45f * (2.0f * fRec15 + -1.0f + 2.0f * fRec13 + -1.0f) + fSlow23 * fRec11[0] - fConst31 * (fConst29 * fRec10[2] + fConst27 * fRec10[1]);
			float fTemp17 = fRec10[2] + fRec10[0] + 2.0f * fRec10[1];
			fVec5[0] = fTemp17;
			fRec9[0] = -(fConst37 * (fConst36 * fRec9[1] - fConst34 * (fTemp17 - fVec5[1])));
			float fTemp18 = 1.0f - fConst41 * fTemp0;
			float fTemp19 = ((iTemp1) ? 0.0f : fSlow31 + fRec18[1]);
			fRec18[0] = fTemp19 - std::floor(fTemp19);
			float fTemp20 = ((iTemp1) ? 0.0f : fSlow32 + fRec19[1]);
			fRec19[0] = fTemp20 - std::floor(fTemp20);
			float fTemp21 = ((iTemp1) ? 0.0f : fSlow33 + fRec20[1]);
			fRec20[0] = fTemp21 - std::floor(fTemp21);
			float fTemp22 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec20[0]), 65535))];
			float fTemp23 = 0.8f * fTemp22 + 0.35f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec19[0]), 65535))] + 0.2f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec18[0]), 65535))];
			fVec7[0] = fTemp23;
			fRec16[0] = -(fConst47 * (fConst46 * fRec16[1] - (fTemp23 + fVec7[1])));
			float fTemp24 = ((iTemp1) ? 0.0f : fSlow37 + fRec23[1]);
			fRec23[0] = fTemp24 - std::floor(fTemp24);
			float fTemp25 = mydsp_faustpower2_f(2.0f * fRec23[0] + -1.0f);
			fVec8[0] = fTemp25;
			float fTemp26 = fSlow38 * fTemp4 * (fTemp25 - fVec8[1]);
			fVec9[IOTA0 & 4095] = fTemp26;
			fRec22[0] = 0.999f * fRec22[1] + fTemp26 - (fSlow44 * fVec9[(IOTA0 - iSlow40) & 4095] + fSlow43 * fVec9[(IOTA0 - iSlow41) & 4095]);
			fRec21[0] = fSlow33 * (2.4f * fRec11[0] + 0.8f * fRec22[0]) - fConst56 * (fConst55 * fRec21[2] + fConst53 * fRec21[1]);
			float fTemp27 = fConst59 * fRec3[0];
			float fTemp28 = fConst58 - fRec3[0];
			float fTemp29 = ((iTemp1) ? 0.0f : fSlow48 + fRec27[1]);
			fRec27[0] = fTemp29 - std::floor(fTemp29);
			float fTemp30 = mydsp_faustpower2_f(2.0f * fRec27[0] + -1.0f);
			fVec10[0] = fTemp30;
			float fTemp31 = fSlow49 * fTemp4 * (fTemp30 - fVec10[1]);
			fVec11[IOTA0 & 2047] = fTemp31;
			fRec26[0] = 0.999f * fRec26[1] + fTemp31 - (fSlow55 * fVec11[(IOTA0 - iSlow51) & 2047] + fSlow54 * fVec11[(IOTA0 - iSlow52) & 2047]);
			float fTemp32 = ((iTemp1) ? 0.0f : fSlow57 + fRec28[1]);
			fRec28[0] = fTemp32 - std::floor(fTemp32);
			float fTemp33 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec28[0]), 65535))];
			float fTemp34 = 0.6f * fTemp22;
			fRec25[0] = fTemp34 + 0.25f * fTemp33 + fSlow56 * fRec26[0] - fConst66 * (fConst64 * fRec25[2] + fConst62 * fRec25[1]);
			float fTemp35 = fRec25[2] + fRec25[0] + 2.0f * fRec25[1];
			fVec12[0] = fTemp35;
			fRec24[0] = -(fConst20 * (fConst19 * fRec24[1] - fConst69 * (fTemp35 - fVec12[1])));
			float fTemp36 = ((iTemp1) ? 0.0f : fSlow59 + fRec31[1]);
			fRec31[0] = fTemp36 - std::floor(fTemp36);
			float fTemp37 = fSlow60 * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec31[0]), 65535))] + 1.0f;
			float fTemp38 = fSlow61 * fTemp37;
			float fTemp39 = std::max<float>(fTemp38, 23.44895f);
			float fTemp40 = std::max<float>(2e+01f, std::fabs(fTemp39));
			float fTemp41 = ((iTemp1) ? 0.0f : fRec32[1] + fConst14 * fTemp40);
			fRec32[0] = fTemp41 - std::floor(fTemp41);
			float fTemp42 = mydsp_faustpower2_f(2.0f * fRec32[0] + -1.0f);
			fVec13[0] = fTemp42;
			float fTemp43 = fTemp4 * (fTemp42 - fVec13[1]) / fTemp40;
			fVec14[IOTA0 & 2047] = fTemp43;
			float fTemp44 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst15 / fTemp39));
			int iTemp45 = static_cast<int>(fTemp44);
			float fTemp46 = std::floor(fTemp44);
			float fTemp47 = fSlow7 * fTemp37;
			float fTemp48 = std::max<float>(1.1920929e-07f, std::fabs(fTemp47));
			float fTemp49 = fRec33[1] + fConst14 * fTemp48;
			float fTemp50 = fTemp49 + -1.0f;
			int iTemp51 = fTemp50 < 0.0f;
			fRec33[0] = ((iTemp51) ? fTemp49 : fTemp50);
			float fRec34 = ((iTemp51) ? fTemp49 : fTemp49 + fTemp50 * (1.0f - fConst0 / fTemp48));
			float fTemp52 = 2.0f * fRec34 + -1.0f;
			fRec30[0] = 0.8f * fTemp52 + fConst76 * (fTemp43 - fVec14[(IOTA0 - iTemp45) & 2047] * (fTemp46 + (1.0f - fTemp44)) - (fTemp44 - fTemp46) * fVec14[(IOTA0 - (iTemp45 + 1)) & 2047]) - fConst75 * (fConst73 * fRec30[2] + fConst71 * fRec30[1]);
			float fTemp53 = fRec30[2] + fRec30[0] + 2.0f * fRec30[1];
			fVec15[0] = fTemp53;
			fRec29[0] = -(fConst20 * (fConst19 * fRec29[1] - fConst77 * (fTemp53 - fVec15[1])));
			float fTemp54 = ((iTemp1) ? 0.0f : fSlow63 + fRec36[1]);
			fRec36[0] = fTemp54 - std::floor(fTemp54);
			float fTemp55 = fTemp34 + 0.4f * fTemp33 + 0.2f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec36[0]), 65535))];
			fVec16[0] = fTemp55;
			fRec35[0] = -(fConst81 * (fConst80 * fRec35[1] - (fTemp55 + fVec16[1])));
			float fTemp56 = std::max<float>(fTemp47, 23.44895f);
			float fTemp57 = std::max<float>(2e+01f, std::fabs(fTemp56));
			float fTemp58 = ((iTemp1) ? 0.0f : fRec39[1] + fConst14 * fTemp57);
			fRec39[0] = fTemp58 - std::floor(fTemp58);
			float fTemp59 = mydsp_faustpower2_f(2.0f * fRec39[0] + -1.0f);
			fVec17[0] = fTemp59;
			float fTemp60 = fTemp4 * (fTemp59 - fVec17[1]) / fTemp57;
			fVec18[IOTA0 & 4095] = fTemp60;
			float fTemp61 = std::max<float>(0.0f, std::min<float>(2047.0f, fConst15 / fTemp56));
			int iTemp62 = static_cast<int>(fTemp61);
			float fTemp63 = std::floor(fTemp61);
			float fTemp64 = ((iTemp1) ? 0.0f : fSlow65 + fRec40[1]);
			fRec40[0] = fTemp64 - std::floor(fTemp64);
			float fTemp65 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec40[0]), 65535))];
			fRec38[0] = 0.7f * fTemp65 + fConst88 * (fTemp60 - fVec18[(IOTA0 - iTemp62) & 4095] * (fTemp63 + (1.0f - fTemp61)) - (fTemp61 - fTemp63) * fVec18[(IOTA0 - (iTemp62 + 1)) & 4095]) - fConst87 * (fConst85 * fRec38[2] + fConst83 * fRec38[1]);
			float fTemp66 = fRec38[2] + fRec38[0] + 2.0f * fRec38[1];
			fVec19[0] = fTemp66;
			fRec37[0] = -(fConst94 * (fConst93 * fRec37[1] - fConst91 * (fTemp66 - fVec19[1])));
			float fTemp67 = std::max<float>(1.1920929e-07f, std::fabs(fTemp38));
			float fTemp68 = fRec43[1] + fConst14 * fTemp67;
			float fTemp69 = fTemp68 + -1.0f;
			int iTemp70 = fTemp69 < 0.0f;
			fRec43[0] = ((iTemp70) ? fTemp68 : fTemp69);
			float fRec44 = ((iTemp70) ? fTemp68 : fTemp68 + fTemp69 * (1.0f - fConst0 / fTemp67));
			fRec42[0] = 0.7f * fTemp52 + 0.3f * (2.0f * fRec44 + -1.0f) - fConst98 * (fConst96 * fRec42[2] + fConst95 * fRec42[1]);
			float fTemp71 = fRec42[2] + fRec42[0] + 2.0f * fRec42[1];
			fVec20[0] = fTemp71;
			fRec41[0] = -(fConst37 * (fConst36 * fRec41[1] - fConst99 * (fTemp71 - fVec20[1])));
			float fTemp72 = ((iTemp1) ? 0.0f : fRec47[1] + fSlow68 * fTemp37);
			fRec47[0] = fTemp72 - std::floor(fTemp72);
			float fTemp73 = ((iTemp1) ? 0.0f : fRec48[1] + fSlow57 * fTemp37);
			fRec48[0] = fTemp73 - std::floor(fTemp73);
			float fTemp74 = ((iTemp1) ? 0.0f : fRec49[1] + fSlow33 * fTemp37);
			fRec49[0] = fTemp74 - std::floor(fTemp74);
			fRec46[0] = 0.6f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec49[0]), 65535))] + 0.3f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec48[0]), 65535))] + 0.15f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec47[0]), 65535))] + 0.2f * fTemp65 - fConst105 * (fConst103 * fRec46[2] + fConst101 * fRec46[1]);
			float fTemp75 = fRec46[2] + fRec46[0] + 2.0f * fRec46[1];
			fVec21[0] = fTemp75;
			fRec45[0] = -(fConst111 * (fConst110 * fRec45[1] - fConst108 * (fTemp75 - fVec21[1])));
			fRec1[0] = std::max<float>(0.0f, std::min<float>(fTemp27, std::max<float>(fConst112 * fTemp28 + 1.0f, 0.3f)) * fTemp18) * (fSlow69 * fRec45[0] + fSlow67 * fRec41[0] + fSlow66 * fRec37[0] + fSlow64 * fRec35[0] + fSlow62 * fRec29[0]) + fSlow58 * fRec24[0] * std::max<float>(0.0f, std::min<float>(fTemp27, std::max<float>(fConst60 * fTemp28 + 1.0f, 0.15f)) * (1.0f - fConst57 * fTemp0)) + fSlow45 * (fRec21[2] + fRec21[0] + 2.0f * fRec21[1]) * std::max<float>(0.0f, std::min<float>(fConst50 * fRec3[0], std::max<float>(fConst51 * (fConst49 - fRec3[0]) + 1.0f, 0.8f)) * (1.0f - fConst48 * fTemp0)) + fSlow34 * fRec16[0] * std::max<float>(0.0f, fTemp18 * std::min<float>(fConst39 * fRec3[0], std::max<float>(fConst40 * (fConst38 - fRec3[0]) + 1.0f, 0.0f))) + fSlow30 * fRec9[0] * std::max<float>(0.0f, std::min<float>(fConst24 * fRec3[0], std::max<float>(fConst25 * (fConst23 - fRec3[0]) + 1.0f, 0.9f)) * (1.0f - fConst22 * fTemp0)) + fSlow22 * fRec4[0] * std::max<float>(0.0f, std::min<float>(fConst6 * fRec3[0], std::max<float>(fConst7 * (fConst5 - fRec3[0]) + 1.0f, 0.7f)) * (1.0f - fConst4 * fTemp0)) - fSlow4 * (fSlow3 * fRec1[2] + fSlow1 * fRec1[1]);
			float fTemp76 = fSlow4 * (fRec1[2] + fRec1[0] + 2.0f * fRec1[1]);
			fVec22[0] = fTemp76;
			fRec0[0] = -(fSlow72 * (fSlow71 * fRec0[1] - fSlow70 * (fTemp76 - fVec22[1])));
			output0[i0] = static_cast<FAUSTFLOAT>(fSlow75 * fRec0[0]);
			output1[i0] = static_cast<FAUSTFLOAT>(fSlow76 * fRec0[0]);
			iVec0[1] = iVec0[0];
			fVec1[1] = fVec1[0];
			iRec2[1] = iRec2[0];
			fRec3[1] = fRec3[0];
	...
	#define FAUST_FILE_NAME "parameters_sounds.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("Filter/Highpass", fHslider5, 2e+01f, 2e+01f, 2e+03f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("Filter/Lowpass", fHslider0, 2e+04f, 2e+02f, 2e+04f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("Modulation/VibratoDepth", fHslider4, 0.003f, 0.0f, 0.02f, 0.0001f);
	FAUST_ADDHORIZONTALSLIDER("Modulation/VibratoRate", fHslider3, 5.0f, 0.1f, 2e+01f, 0.1f);
	FAUST_ADDHORIZONTALSLIDER("Spatial/Pan", fHslider6, 0.5f, 0.0f, 1.0f, 0.01f);
	...
	FAUST_ADDHORIZONTALSLIDER("volume", fHslider7, 0.5f, 0.0f, 1.0f, 0.001f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Filter/Highpass, "Filter/Highpass", fHslider5, 2e+01f, 2e+01f, 2e+03f, 1.0f) \
		p(HORIZONTALSLIDER, Filter/Lowpass, "Filter/Lowpass", fHslider0, 2e+04f, 2e+02f, 2e+04f, 1.0f) \
		p(HORIZONTALSLIDER, Modulation/VibratoDepth, "Modulation/VibratoDepth", fHslider4, 0.003f, 0.0f, 0.02f, 0.0001f) \
		p(HORIZONTALSLIDER, Modulation/VibratoRate, "Modulation/VibratoRate", fHslider3, 5.0f, 0.1f, 2e+01f, 0.1f) \
		p(HORIZONTALSLIDER, Spatial/Pan, "Spatial/Pan", fHslider6, 0.5f, 0.0f, 1.0f, 0.01f) \
		...
		p(HORIZONTALSLIDER, volume, "volume", fHslider7, 0.5f, 0.0f, 1.0f, 0.001f) \
...
parameters_sounds::parameters_sounds() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
parameters_sounds::~parameters_sounds()
{
    delete fDSP;
    delete fUI;
    for (int i = 0; i < fDSP->getNumInputs(); i++) {
...
void parameters_sounds::updateImp(void)
{
#if MIDICTRL
...
void parameters_sounds::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void parameters_sounds::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float parameters_sounds::getParamValue(const std::string& path)
{
