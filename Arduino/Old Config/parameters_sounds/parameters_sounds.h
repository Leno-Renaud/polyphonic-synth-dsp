/************************************************************************
 ...
 You should have received opy of the GNU General Public License
...
#ifndef faust_parameters_sounds_h_
#define faust_parameters_sounds_h_
...
class parameters_sounds : public AudioStream
{
    public:
