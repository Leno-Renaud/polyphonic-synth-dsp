...
struct mydsp : public dsp {
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "v2_10_sounds.dsp");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("v2_10_sounds");
		ui_interface->addHorizontalSlider("freq", &fHslider0, FAUSTFLOAT(4.4e+02f), FAUSTFLOAT(27.5f), FAUSTFLOAT(4186.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("mode", &fHslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(9.0f), FAUSTFLOAT(1.0f));
	...
	#define FAUST_FILE_NAME "v2_10_sounds.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("mode", fHslider1, 0.0f, 0.0f, 9.0f, 1.0f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		...
		p(HORIZONTALSLIDER, mode, "mode", fHslider1, 0.0f, 0.0f, 9.0f, 1.0f) \
...
v2_10_sounds::v2_10_sounds() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void v2_10_sounds::updateImp(void)
{
#if MIDICTRL
...
void v2_10_sounds::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void v2_10_sounds::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float v2_10_sounds::getParamValue(const std::string& path)
{
