...
struct mydsp : public dsp {
	...
	virtual void instanceResetUserInterface() {
		fHslider0 = static_cast<FAUSTFLOAT>(1e+04f);
		...
		fHslider6 = static_cast<FAUSTFLOAT>(0.005f);
		fHslider7 = static_cast<FAUSTFLOAT>(0.08f);
		fHslider8 = static_cast<FAUSTFLOAT>(0.3f);
		fHslider9 = static_cast<FAUSTFLOAT>(2e+01f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("ADSR/Attack", &fHslider6, FAUSTFLOAT(0.005f), FAUSTFLOAT(0.001f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("ADSR/Decay", &fHslider7, FAUSTFLOAT(0.08f), FAUSTFLOAT(0.001f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("ADSR/Release", &fHslider5, FAUSTFLOAT(0.2f), FAUSTFLOAT(0.001f), FAUSTFLOAT(3.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("ADSR/Sustain", &fHslider8, FAUSTFLOAT(0.3f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->addHorizontalSlider("Filter/Highpass", &fHslider9, FAUSTFLOAT(2e+01f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(2e+03f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("Filter/Lowpass", &fHslider0, FAUSTFLOAT(1e+04f), FAUSTFLOAT(2e+02f), FAUSTFLOAT(2e+04f), FAUSTFLOAT(1.0f));
	...
	FAUST_ADDHORIZONTALSLIDER("ADSR/Attack", fHslider6, 0.005f, 0.001f, 2.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("ADSR/Decay", fHslider7, 0.08f, 0.001f, 2.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("ADSR/Release", fHslider5, 0.2f, 0.001f, 3.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("ADSR/Sustain", fHslider8, 0.3f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("Filter/Highpass", fHslider9, 2e+01f, 2e+01f, 2e+03f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("Filter/Lowpass", fHslider0, 1e+04f, 2e+02f, 2e+04f, 1.0f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, ADSR/Attack, "ADSR/Attack", fHslider6, 0.005f, 0.001f, 2.0f, 0.001f) \
		p(HORIZONTALSLIDER, ADSR/Decay, "ADSR/Decay", fHslider7, 0.08f, 0.001f, 2.0f, 0.001f) \
		p(HORIZONTALSLIDER, ADSR/Release, "ADSR/Release", fHslider5, 0.2f, 0.001f, 3.0f, 0.001f) \
		p(HORIZONTALSLIDER, ADSR/Sustain, "ADSR/Sustain", fHslider8, 0.3f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, Filter/Highpass, "Filter/Highpass", fHslider9, 2e+01f, 2e+01f, 2e+03f, 1.0f) \
		p(HORIZONTALSLIDER, Filter/Lowpass, "Filter/Lowpass", fHslider0, 1e+04f, 2e+02f, 2e+04f, 1.0f) \
